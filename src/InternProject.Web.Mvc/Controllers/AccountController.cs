...
using InternProject.Sessions;
using InternProject.Web.Models.Account;
using InternProject.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : InternProjectControllerBase
{
