...
using InternProject.Models.TokenAuth;
using InternProject.Web.Startup;
...
namespace InternProject.Web.Tests;

public abstract class InternProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static InternProjectWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(InternProjectWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<InternProjectDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<InternProjectDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<InternProjectDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<InternProjectDbContext, Task<T>> func)
    {
        T result;
